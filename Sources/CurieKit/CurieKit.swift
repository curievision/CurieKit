...
public final actor CurieKit {
    ...
    private let service = CurieService()
    ...
    public func getProduct(with productId: String) async throws -> CurieProduct? {
        try await service.getProduct(with: productId)
    }
